"""Django settings for portcast project.
...
APPS_DIR = ROOT_DIR.path("portcast")
...
# ------------------------------------------------------------------------------
REST_FRAMEWORK = {
    "DEFAULT_PAGINATION_CLASS": "portcast.base.api.pagination.LimitOffsetPagination",
    "PAGE_SIZE": 30,
    # Default renderer classes for Rest framework
    "DEFAULT_RENDERER_CLASSES": [
        "portcast.base.renderers.PortcastApiRenderer",
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": (
        ...
        "portcast.users.auth.backends.UserTokenAuthentication",
        # Mainly used for api debug.
        "rest_framework.authentication.SessionAuthentication",
    ),
    "DEFAULT_SCHEMA_CLASS": "rest_framework.schemas.coreapi.AutoSchema",
    "EXCEPTION_HANDLER": "portcast.base.exceptions.exception_handler",
}
...
SITE_NAME = env("SITE_NAME", default="portcast")
...
FRONTEND_SITE_NAME = env("FRONTEND_SITE_NAME", default="portcast")
...
DEFAULT_FROM_EMAIL = env(
    "DEFAULT_FROM_EMAIL", default="portcast <support@portcast.com>"
)
EMAIL_SUBJECT_PREFIX = env("EMAIL_SUBJECT_PREFIX", default="[portcast] ")
...
DATABASES = {"default": env.db("DATABASE_URL", default="postgres:///portcast")}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                "portcast.base.context_processors.site_settings",
...
CSRF_FAILURE_VIEW = "portcast.base.views.csrf_failure"
...
LOGGING = {
    ...
    "loggers": {
        ...
        "portcast": {"handlers": ["console"], "level": "INFO", "propagate": False},
